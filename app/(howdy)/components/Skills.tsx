...
const Skills = () => {
    ...
    return (
        <div className="w-full md:w-[75%] flex flex-col items-center pt-32 py-12 text-primary-foreground">
        <h1
          className=
        ...
        >
          Skillset
            ...
            <div className=" w-full flex justify-center items-center">
                ...
                <div className="flex flex-col md:flex-row gap-y-1 w-[80%] py-4 text-sm">
