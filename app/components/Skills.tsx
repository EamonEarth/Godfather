        ...
        <div className="w-full md:w-[75%] flex flex-col items-center md:pt-32 py-12 text-primary-foreground">
            ...
            <div className=" w-full flex justify-center items-center">
                <div className="flex flex-col w-[90%] md:w-[60%] items-center">
                    ...
                    <div style={{ animation: "pulse 4s ease-in-out infinite"}} className="rounded-3xl w-full h-[30px] bg-gradient-to-r from-amber-200  via-yellow-500  to-lime-500 to-70% opacity-70"/>
                </div>
            </div>
